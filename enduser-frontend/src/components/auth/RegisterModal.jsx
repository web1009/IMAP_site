...
function RegisterModal({ isOpen, onClose }) {
    ...
    const { userName, password, email, phoneNumber, address, birthDate, cashPoint, gradePoint, agreeAt } = formState;
        ...
        <div className="modal-overlay">
            <div className="modal-content">
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                        <label htmlFor="password" style={{ minWidth: '80px', textAlign: 'right' }}>비밀번호:</label>
                        <input
                            id="password"
                            type="password"
                            placeholder="비밀번호"
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                        <label htmlFor="email" style={{ minWidth: '80px', textAlign: 'right' }}>이메일:</label>
                        <input
                            id="email"
                            type="email"
                            placeholder="이메일"
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                        <label htmlFor="phoneNumber" style={{ minWidth: '80px', textAlign: 'right' }}>전화번호:</label>
                        <input
                            id="phoneNumber"
                            type="tel"
                            placeholder="전화번호"
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                        <label htmlFor="address" style={{ minWidth: '80px', textAlign: 'right' }}>주소:</label>
                        <input
                            id="address"
                            type="text"
                            placeholder="주소"
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
                        <label htmlFor="birthDate" style={{ minWidth: '80px', textAlign: 'right' }}>생년월일:</label>
                        <input
                            id="birthDate"
                            type="date"
                            placeholder="생년월일"
